...
A la quarta activitat vam haver de crear una IA personalitzada, en aquest cas s'ens demanava utilitzar n8n, durant el procés vam anar ajuntant diferents nodes per les parts del xatbot com podrien ser un node per a quan fa preguntes, un per a donar resposta, o un per a l'agent d'IA que utilitzaríem, però l'important era un que ho ajuntava tot i ho processava segons un script d'ordres que li havíem proporcionat prèviament.
